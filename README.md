...
Each experiment is maintained in its **own separate repository**, following the naming convention:

```
AIDS_Sem7_NLP_Experiment01
AIDS_Sem7_NLP_Experiment02
...
```

Every individual experiment repository contains:
- Source code files
...
All experiments are original work, with proper citations provided wherever reference material has been used. Commit history reflects genuine, timely progress on each experiment.

## 📜 License / Usage

This repository is maintained solely for academic and evaluation purposes as per the Department of Artificial Intelligence & Data Science guidelines.
